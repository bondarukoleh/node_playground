...
const help = _ => console.log('Please provide agument "-r" and path to file you want to read');
const checkFile = filePath => {
  let stat = null;
  try {
    stat = fs.lstatSync(filePath)
  } catch(e) {
    console.error('Valid path to file shold be provided. Use "-h" argument to see help');
